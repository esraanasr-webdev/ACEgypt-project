        ...
        <section className="mx-auto max-w-[1200px] py-20">
            ...
            <div className="max-w-[760px]">
                ...
                <p className="mt-3 text-[16px] leading-[1.6] text-[var(--color-grey-strong)]">
                    Leave your details and one of our academic advisors will contact you
                    to help you choose the right program for your goals.
                </p>
            </div>
                ...
                <div className="relative min-h-[600px]">
                    ...
                    <div className="absolute inset-[-60px]">
                        <Image
                            ...
                            alt="Journey mask behind the student"
                            fill
